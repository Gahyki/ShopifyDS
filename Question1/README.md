...
![Naively calculated average code](/Question1/Screenshots/NaivelyCalculatedValueCode.png)  
![Naively calculated average](/Question1/Screenshots/NaivelyCalculatedValue.png)  
...
![Sorted dataframe code](/Question1/Screenshots/BulkOrderCode.png)
![Sorted dataframe](/Question1/Screenshots/BulkOrder.png)  
...
![AOV after removing bulk orders code](/Question1/Screenshots/PostBulkAOVCode.png)  
![AOV after removing bulk orders](/Question1/Screenshots/PostBulkAOV.png)  
...
![Item prices code](/Question1/Screenshots/ItemPricesCode.png)  
![Item prices](/Question1/Screenshots/ItemPrices.png)  
...
![AOV without high price items code](/Question1/Screenshots/PostHighPriceAOVCode.png)  
![AOV without high price items](/Question1/Screenshots/PostHighPriceAOV.png)  
...
![High price item contribution in percentage code](/Question1/Screenshots/HighPriceContributionCode.png)  
![High price item contribution in percentage](/Question1/Screenshots/HighPriceContribution.png)  
...
![AOV with high price items](/Question1/Screenshots/PostBulkAOV.png)  
![AOV without high price items](/Question1/Screenshots/PostHighPriceAOV.png)  
  
The following is the list of top ten most popular items in order of frequency:  
![Popularity by order frequency code](/Question1/Screenshots/PopularityByOrderFrequencyCode.png)  
![Popularity by order frequency](/Question1/Screenshots/PopularityByOrderFrequency.png)  
  
and a graphical representation of the popularity of each item price (by order of frequency):  
![Popularity graph code](/Question1/Screenshots/PopularityGraphCode.png)  
![Popularity graph](/Question1/Screenshots/PopularityGraph.png)  
